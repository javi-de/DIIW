...
function areoi_register_block_list_group_item() 
{
	register_block_type_from_metadata(
		__DIR__ . '/list-group-item',
		array(
			'render_callback' => 'areoi_render_block_list_group_item',
		)
	);
}

areoi_register_block_list_group_item();