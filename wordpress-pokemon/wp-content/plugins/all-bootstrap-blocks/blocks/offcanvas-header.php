...
function areoi_register_block_offcanvas_header() 
{
	register_block_type_from_metadata(
		__DIR__ . '/offcanvas-header',
		array(
			'render_callback' => 'areoi_render_block_offcanvas_header',
		)
	);
}

areoi_register_block_offcanvas_header();